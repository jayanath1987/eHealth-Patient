...
<div class="panel panel-default"  >
	...
	echo  "<tr><td>Civil Status:</td><td>".$patient_info["Personal_Civil_Status"]."</td><td></td></tr>\n";
		echo  "<tr>";
	if ($patient_info["occupation"]!="0"){
		echo  "<td>Occupation:</td><td>".$patient_info["occupation"]."</td>\n";
	}

	if ($patient_info["Guardian_Name"]!="0"){
		echo  "<td>Guardian info:</td><td>".$patient_info["Guardian_Name"];
		if ($patient_info["guardian_relationship"]!="0"){
			echo " (".$patient_info["guardian_relationship"].")";
		}
		if ($patient_info["guardian_contact"]!="0"){
			echo " TEL:".$patient_info["guardian_contact"]."";
		}
		if ($patient_info["guardian_address"]!="0"){
			echo "<br>".$patient_info["guardian_address"]."";
		}
		echo "</td>\n";
	}
	echo  "</tr>";
